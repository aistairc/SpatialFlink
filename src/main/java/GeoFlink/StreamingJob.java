...
public class StreamingJob implements Serializable {
	...
	public static void main(String[] args) throws Exception {
		...
		String delimiter1 = params.queryDelimiter1;
		...
		String delimiter2 = params.queryDelimiter2;
		...
		*/
		...
		switch(queryOption) {
			...
			case 1: { // Range Query (Window-based) - Point-Stream-Point-Query
				...
				DataStream<Point> spatialPointStream = Deserialization.TrajectoryStream(geoJSONStream, inputFormat, inputDateFormat, delimiter1, csvTsvSchemaAttr1, "timestamp", "oID", uGrid);
			...
			case 16: { // Range Query (Window-based) - Polygon-Stream-Point-Query
				...
				DataStream<Polygon> spatialPolygonStream = Deserialization.TrajectoryStreamPolygon(geoJSONStream, inputFormat, inputDateFormat, delimiter1,"timestamp", "oID", uGrid);
			...
			case 31: { // Range Query (Window-based) - LineString-Stream-Point-Query
				...
				DataStream geoJSONStream  = env.addSource(new FlinkKafkaConsumer<>(inputTopicName, new JSONKeyValueDeserializationSchema(false), kafkaProperties).setStartFromEarliest());
				// Converting GeoJSON,CSV stream to polygon spatial data stream
				DataStream<LineString> spatialLineStringStream = Deserialization.TrajectoryStreamLineString(geoJSONStream, inputFormat, inputDateFormat, delimiter1,"timestamp", "oID", uGrid);
			...
			case 101: { // Join (Window-base) - Point-Stream-Point-Query
				...
				DataStream<Point> queryStream = Deserialization.TrajectoryStream(geoJSONQueryStream, inputFormat, queryDateFormat, delimiter1, csvTsvSchemaAttr1, "timestamp", "oID", qGrid);
			...
			case 106: { // Join (Window-base) - Point-Stream-Polygon-Query
				...
				//Generating query stream
				DataStream geoJSONQueryStream  = env.addSource(new FlinkKafkaConsumer<>(queryTopicName, new JSONKeyValueDeserializationSchema(false),kafkaProperties).setStartFromLatest());
				DataStream<Polygon> queryStream = Deserialization.TrajectoryStreamPolygon(geoJSONQueryStream, inputFormat, queryDateFormat, delimiter1, "timestamp", "oID", qGrid);
			...
			case 111: { // Join (Window-base) - Point-Stream-LineString-Query
				...
				//Generating query stream
				DataStream geoJSONQueryStream  = env.addSource(new FlinkKafkaConsumer<>(queryTopicName, new JSONKeyValueDeserializationSchema(false),kafkaProperties).setStartFromLatest());
				DataStream<LineString> queryStream = Deserialization.TrajectoryStreamLineString(geoJSONQueryStream, inputFormat, queryDateFormat, delimiter1, "timestamp", "oID", qGrid);
...
//				spatialJoinStreamOptimized.print();
			...
			case 201:{ // TFilterQuery Real-time
				DataStream<Point> spatialTrajectoryStream = Deserialization.TrajectoryStream(inputStream, inputFormat, inputDateFormat, delimiter1, csvTsvSchemaAttr1, "timestamp", "oID", uGrid);
			...
			case 209:{ // TSpatialJoinQuery Real-time
				...
				DataStream<Point> spatialQueryStream = Deserialization.TrajectoryStream(queryStream, inputFormat, inputDateFormat, delimiter1, csvTsvSchemaAttr1, "timestamp", "oID", uGrid);
...
//				pointPolygonRangeQueryOutput.print();
			...
			case 701:{ // TFilterQuery (GeoJSON Point Timestamp)
				DataStream geoJSONStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new JSONKeyValueDeserializationSchema(false), kafkaProperties).setStartFromEarliest());
				DataStream<Point> spatialTrajectoryStream = Deserialization.TrajectoryStream(geoJSONStream, "GeoJSON", inputDateFormat, delimiter1, csvTsvSchemaAttr1, "timestamp", "oID", uGrid);
				spatialTrajectoryStream.print();
			...
			case 702:{ // TFilterQuery (GeoJSON Polygon Timestamp)
				DataStream geoJSONStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new JSONKeyValueDeserializationSchema(false), kafkaProperties).setStartFromEarliest());
				DataStream<Polygon> spatialTrajectoryStream = Deserialization.TrajectoryStreamPolygon(geoJSONStream, "GeoJSON", inputDateFormat, delimiter1, "timestamp", "oID", uGrid);
				spatialTrajectoryStream.print();
			...
			case 703:{ // TFilterQuery (GeoJSON LineString Timestamp)
				DataStream geoJSONStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new JSONKeyValueDeserializationSchema(false), kafkaProperties).setStartFromEarliest());
				DataStream<LineString> spatialTrajectoryStream = Deserialization.TrajectoryStreamLineString(geoJSONStream, "GeoJSON", inputDateFormat, delimiter1, "timestamp", "oID", uGrid);
				spatialTrajectoryStream.print();
			...
			case 704:{ // GeometryCollection (GeoJSON GeometryCollection Timestamp)
				DataStream geoJSONStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new JSONKeyValueDeserializationSchema(false), kafkaProperties).setStartFromEarliest());
				DataStream<GeometryCollection> spatialTrajectoryStream = Deserialization.TrajectoryStreamGeometryCollection(geoJSONStream, "GeoJSON", inputDateFormat, delimiter1, "timestamp", "oID", uGrid);
				spatialTrajectoryStream.print();
			...
			case 705:{ // MultiPoint (GeoJSON MultiPoint Timestamp)
				DataStream geoJSONStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new JSONKeyValueDeserializationSchema(false), kafkaProperties).setStartFromEarliest());
				DataStream<MultiPoint> spatialTrajectoryStream = Deserialization.TrajectoryStreamMultiPoint(geoJSONStream, "GeoJSON", inputDateFormat, delimiter1, "timestamp", "oID", uGrid);
				spatialTrajectoryStream.print();
			...
			case 801:{ // Point (CSV Point Timestamp)
				DataStream csvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<Point> spatialTrajectoryStream = Deserialization.TrajectoryStream(csvStream, "CSV", inputDateFormat, delimiter1, csvTsvSchemaAttr1, "timestamp", "oID", uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.PointToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 802:{ // Polygon (CSV Polygon Timestamp)
				DataStream csvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<Polygon> spatialTrajectoryStream = Deserialization.TrajectoryStreamPolygon(csvStream, "CSV", inputDateFormat, delimiter1, null, null,uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.PolygonToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 803:{ // LineString (CSV LineString Timestamp)
				DataStream csvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<LineString> spatialTrajectoryStream = Deserialization.TrajectoryStreamLineString(csvStream, "CSV", inputDateFormat, delimiter1, null, null, uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.LineStringToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 804:{ // GeometryCollection (CSV GeometryCollection Timestamp)
				DataStream csvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<GeometryCollection> spatialTrajectoryStream = Deserialization.TrajectoryStreamGeometryCollection(csvStream, "CSV", inputDateFormat, delimiter1, null, null, uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.GeometryCollectionToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 805:{ // MultiPoint (CSV MultiPoint Timestamp)
				DataStream csvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<MultiPoint> spatialTrajectoryStream = Deserialization.TrajectoryStreamMultiPoint(csvStream, "CSV", inputDateFormat, delimiter1, null, null, uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.MultiPointToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 901:{ // Point (TSV Point Timestamp)
				DataStream tsvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<Point> spatialTrajectoryStream = Deserialization.TrajectoryStream(tsvStream, "TSV", inputDateFormat, delimiter1, csvTsvSchemaAttr1, null, null, uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.PointToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 902:{ // Polygon (TSV Polygon Timestamp)
				DataStream tsvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<Polygon> spatialTrajectoryStream = Deserialization.TrajectoryStreamPolygon(tsvStream, "TSV", inputDateFormat, delimiter1, null, null, uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.PolygonToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 903:{ // LineString (TSV LineString Timestamp)
				DataStream tsvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<LineString> spatialTrajectoryStream = Deserialization.TrajectoryStreamLineString(tsvStream, "TSV", inputDateFormat, delimiter1, null, null, uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.LineStringToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 904:{ // GeometryCollection (TSV GeometryCollection Timestamp)
				DataStream tsvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<GeometryCollection> spatialTrajectoryStream = Deserialization.TrajectoryStreamGeometryCollection(tsvStream, "TSV", inputDateFormat, delimiter1, null, null, uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.GeometryCollectionToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
			case 905:{ // MultiPoint (TSV MultiPoint Timestamp)
				DataStream tsvStream = env.addSource(new FlinkKafkaConsumer<>("kafka", new SimpleStringSchema(Charset.forName(charset1)), kafkaProperties).setStartFromEarliest());
				DataStream<MultiPoint> spatialTrajectoryStream = Deserialization.TrajectoryStreamMultiPoint(tsvStream, "TSV", inputDateFormat, delimiter1, null, null, uGrid);
				spatialTrajectoryStream.print();
				spatialTrajectoryStream.addSink(new FlinkKafkaProducer<>("kafka", new Serialization.MultiPointToCSVTSVOutputSchema("kafka", inputDateFormat, delimiter1), kafkaProperties, FlinkKafkaProducer.Semantic.EXACTLY_ONCE));
				break;
			}
...
//				Path path = new Path("D:\\testData\\linestring\\C23-06_05_GML\\C23-06_05-g_Coastline.shp");
			...
			case 1011:{
				...
				// Converting GeoJSON,CSV stream to point spatial data stream
				DataStream<Polygon> spatialStream = Deserialization.TrajectoryStreamPolygon(geoJSONStream, inputFormat, inputDateFormat, delimiter1, "timestamp", "oID", uGrid);
				//spatialStream.print();
				//trajIDs = Stream.of("1001", "2059", "1741", "1415", "2565").collect(Collectors.toSet());
				//trajIDs = Stream.of("0").collect(Collectors.toSet());
				//Set<String> trajIDSet = Stream.of("1001", "2059", "1741", "1415", "2565").collect(Collectors.toSet());
			...
			case 1012: {
				...
				//pointStream.print();
				// Converting GeoJSON,CSV stream to point spatial data stream
				DataStream<Point> spatialPointStream = Deserialization.TrajectoryStream(pointStream, inputFormat, inputDateFormat, delimiter1, csvTsvSchemaAttr1, ordinaryStreamAttributeNames.get(1), ordinaryStreamAttributeNames.get(0), uGrid);
				//spatialPointStream.print();
				...
				//DataStream polygonStream  = env.addSource(new FlinkKafkaConsumer<>(queryTopicName, new JSONKeyValueDeserializationSchema(false), kafkaProperties).setStartFromEarliest());
				 //Converting GeoJSON,CSV stream to point spatial data stream
				DataStream<Polygon> spatialPolygonStream = Deserialization.TrajectoryStreamPolygon(polygonStream, inputFormat, inputDateFormat, delimiter1, queryStreamAttributeNames.get(1), queryStreamAttributeNames.get(0), uGrid);
				//spatialPolygonStream.print();
			...
			case 2000:{ //DEIM Check-In
				...
				inputFormat = "JSON";
				DataStream<Point> deimCheckInStream = Deserialization.TrajectoryStream(pointStream, inputFormat, inputDateFormat, delimiter1, csvTsvSchemaAttr1, ordinaryStreamAttributeNames.get(1), ordinaryStreamAttributeNames.get(0), uGrid);
