...
public class LineStringPointPointTKNNQuery extends TKNNQuery<LineString, Point, Point> {
    public LineStringPointPointTKNNQuery(QueryConfiguration conf, SpatialIndex index) {
        super.initializeTKNNQuery(conf, index);
    }

    public DataStream<Tuple2<LineString, Double>> run(DataStream<Point> pointStream, Point queryPoint, double queryRadius, Integer k) {
