...
public class LineStringPointTJoinQuery extends TJoinQuery<LineString, Point> {
    public LineStringPointTJoinQuery(QueryConfiguration conf, SpatialIndex index) {
        super.initializeKNNQuery(conf, index);
    }

    public DataStream<Tuple2<LineString, LineString>> run(DataStream<Point> ordinaryPointStream, DataStream<Point> queryPointStream, double joinDistance) {
